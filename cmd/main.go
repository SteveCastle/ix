...
func main() {
	categories := []string{"tier", "subject", "genre", "type", "source", "action"}

	app := &cli.App{
		Name:    "ix",
		Usage:   "IX is a simple file indexer that uses a simple file structure to store metadata about files.",
		Version: "0.0.1",
